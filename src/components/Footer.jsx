...
const Footer = () => {
  return (
    <footer className="bg-[#503d2a] text-white p-10">

      <div className="flex items-center justify-center space-x-2 mt-5 mx-auto">
      <svg fill="#ffffff" height= "50"version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
<g>
	<g>
        ...
        <p className="ml-2">© 1996–2024, Library.com, Inc. or its affiliates</p>
      </div>
    </footer>
  );
};
